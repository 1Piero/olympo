  ...
  return (
    <div>
      ...
      <section className="relative flex h-screen min-h-[600px] w-full items-center justify-start overflow-hidden">
        ...
        />
        <div className="absolute inset-0 bg-gradient-to-r from-olympo-black/90 via-olympo-black/40 to-transparent from-0% via-40% to-70%" />

        <div className="relative z-10 max-w-2xl px-6 text-center animate-fade-up md:ml-16 lg:ml-24">
